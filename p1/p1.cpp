...
void Draw(struct Record* records) {
	...
	cout << "+"; cout.width(94); cout.fill('-'); cout << '+' << endl;
	cout.fill(' '); cout.width(width - 1);  cout << left << "|Прайс-лист"; cout << "|" << endl;
	cout.fill('-'); cout.width(94); cout << "+"; cout << "+" << endl;
	cout.fill(' ');
...
//{
//	cout << "| Прайс-лист           ";
//	cout.width(75 - sizeof("|Прайс-лист|"));
//	cout.fill(' ');
//	cout << '|' << endl;
//}
//
//void LineOne()
//{
//	cout << "| Наименование товара | Тип товара | Цена за 1 шт.  | Минимум кол-во |     Дата     |";
//	cout << ' ' << endl;
//
//}
//
//void LineTwo()
//{
//	cout << "|Папка                |К           |4.75000 (грн)   |4               |   03.07.2022 |";
//	cout << ' ' << endl;
//}
//
//void LineThree()
//{
//	cout << "|Бумага               |К           |13.90000 (грн)  |10              |   03.04.2021 |";
//	cout << ' ' << endl;
//}
//
//void LineFour()
//{
//	cout << "|Калькулятор          |О           |411.00000 (грн) |1               |   04.03.2022 |";
//	cout << ' ' << endl;
//}
//
//void LineFive()
...
//	cout.width(86 - sizeof("|Примечание: К – канцтовары, О – оргтехника"));
//	cout.fill(' ');
//	cout << '|' << endl;
//	
//}
